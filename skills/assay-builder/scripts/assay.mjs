#!/usr/bin/env node
// Skill-local launcher for the bundled-in-repo Assay CLI.
//
// The skill lives at <repo>/skills/assay-builder and is installed by
...
if (!repoRoot) {
  process.stderr.write(
    "assay: could not locate the assay repo from this skill.\n" +
